...
interface GameContextValue {
  ...
  // Weather forecast queue (up to 4 entries pre-generated by the server)
...
export function GameProvider({ children }: { children: React.ReactNode }) {
  ...
  const { activeType: activeWeather, isActive: weatherIsActive, msLeft: weatherMsLeft, forecast: weatherForecast } = useWeather();
