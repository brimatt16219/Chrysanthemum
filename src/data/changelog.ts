...
export const CHANGELOGS: ChangelogEntry[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { type: "changed", text: "Mutation sell multipliers rebalanced — Rainbow 5×, Wet 1.1×, Windstruck 0.7×, Shocked 2.5×; client and server now fully in sync" },
      { type: "changed", text: "Fan now strips Wet mutation only (not all mutations); Windstruck application uses a separate ~15%/hr rate across all tiers" },
      { type: "changed", text: "Prismatic Skies weather weight reduced from 10 → 3, making Rainbow mutations significantly rarer" },
