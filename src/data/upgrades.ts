...
export const FERTILIZERS: Record<FertilizerType, Fertilizer> = {
  ...
  elite:   { id: "elite",   name: "Elite Fertilizer",   description: "Speeds growth by 3.5×.", emoji: "⚗️", speedMultiplier: 3, shopPrice: 2500, color: "text-yellow-400", shopWeight: 5 },
  miracle: { id: "miracle", name: "Miracle Fertilizer", description: "Speeds growth by 5×.", emoji: "💫", speedMultiplier: 4, shopPrice: 10000, color: "text-pink-400", shopWeight: 2 },
};
