...
export const RARITY_CONFIG: Record<Rarity, {
  ...
  exalted:   { label: "Exalted",   color: "text-slate-300",  glow: "shadow-[0_0_24px_rgba(226,232,240,0.6)]",                                                             borderGrowing: "border-slate-300/25",   borderBloom: "border-slate-300/70",   bgBloom: "bg-slate-300/10"   },
  prismatic: { label: "Prismatic", color: "bg-gradient-to-r from-rose-400 via-violet-400 to-cyan-400 bg-clip-text text-transparent", glow: "shadow-[0_0_32px_rgba(192,132,252,0.5),0_0_16px_rgba(244,114,182,0.4),0_0_12px_rgba(34,211,238,0.4)]", borderGrowing: "border-violet-400/30", borderBloom: "border-violet-400/90", bgBloom: "bg-violet-400/15" },
};
